  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "from": { boxShadow: "0 0 18px hsla(var(--primary), 0.6)", transform: "scale(1)" },
          "to": { boxShadow: "0 0 30px hsla(var(--primary), 1), 0 0 40px hsla(var(--primary), 0.6)", transform: "scale(1.02)" },
        }
      },
      animation: {
